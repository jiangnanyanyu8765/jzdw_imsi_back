...
public class MrMapperForOtt extends Mapper<LongWritable, Text, LocatorCombinedKeyMr, Text> {
    String groupTag = "mr";
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        try {
            ...
            manager = (MrOttDecode) c.newInstance();
            manager.init(conf);
        } catch (Exception e) {
            e.printStackTrace();
            return;
    ...
    public void getbasicParamList(MrPoint mrPoint) {
        ...
        basicParamList.add(mrPoint.getImsi());
    }
}
