...
public class MrOttUpReducer2 extends Reducer<LocatorCombinedKeyMr, Text, NullWritable, Text> {
    private static final Logger LOG = LoggerFactory.getLogger(MrOttUpReducer2.class);
...
//                    ottList.add(ott);
                    ...
                    if (xdrArr[0] != null && xdrArr[1] != null && !mrPointList.isEmpty()) {
                        // TODO mr ott 关联
                        imsi2MrJoins.attachToMrPointList(mrPointList, xdrArr, context);
                        // TODO 输出
